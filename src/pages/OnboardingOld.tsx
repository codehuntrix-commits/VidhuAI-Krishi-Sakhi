...
const Onboarding = () => {
  ...
  const facilities = [
    ...
    { id: 'storage', name: 'Storage', icon: '🏪', nameML: 'സംഭരണം' },
    { id: 'machinery', name: 'Machinery', icon: '🚜', nameML: 'യന്ത്രങ്ങൾ' },
    { id: 'greenhouse', name: 'Greenhouse', icon: '🏠', nameML: 'ഹരിത ഗൃഹം' },
    { id: 'other', name: 'Other', icon: '⚙️', nameML: 'മറ്റുള്ളവ' }
  ];
  ...
  const toggleFacility = (facilityId: string) => {
    if (facilityId === 'other') {
      setShowOtherModal({ show: true, type: 'facility', value: profile.facilitiesOther });
      return;
    }
    setProfile(prev => ({
      ...prev,
  ...
  const handleOtherSubmit = () => {
    ...
    setProfile(prev => ({
      ...prev,
      [`${type}sOther`]: value,
      [type === 'crop' ? 'crops' : type === 'livestock' ? 'livestock' : 'facilities']: 
        [...prev[type === 'crop' ? 'crops' : type === 'livestock' ? 'livestock' : 'facilities'], 'other']
    }));
          ...
          {step === 0 && (
            ...
            {step === 3 && (
              ...
              >
                ...
                <Button onClick={handleNext} disabled={!profile.name || !profile.phone} className="w-full">
                  Continue
                </Button>
              </motion.div>
            )}
            ...
            {step === 4 && (
              ...
              >
                ...
                <Button onClick={handleNext} disabled={!profile.landType || !profile.farmingType} className="w-full">
                  Continue
                </Button>
              </motion.div>
            )}
            ...
            {step === 5 && (
              ...
              >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {facilities.map(facility => (
                        <motion.button
                          ...
                          className={`p-4 rounded-xl border-2 transition-all ${
                            profile.facilities.includes(facility.id)
                              ? 'border-harvest-yellow bg-harvest-yellow/10'
                              : 'border-white/20 bg-white/5'
                          }`}
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                        >
                          ...
                          <div className="text-xs text-foreground/60">{facility.nameML}</div>
                        </motion.button>
                      ))}
                    </div>
                  </div>
                ...
                <Button onClick={handleNext} disabled={profile.crops.length === 0} className="w-full">
                  Continue
                </Button>
              </motion.div>
            )}
            ...
            {step === 6 && (
              ...
              >
                ...
                <div className="space-y-4 text-left">
                  ...
                  <Card className="glass-card p-4">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold">Crops & Assets</h4>
            ...
            {step === 7 && (
              ...
              >
                ...
                <p className="text-lg text-foreground/80 mb-8">
                  Your smart farming journey starts now.<br />
                  <span className="text-farm-green font-semibold">Krishi Sakhi</span> is ready to help you grow better!
                </p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-2">
                        <Button onClick={handleOtherSubmit} className="flex-1">
                          Add
                        </Button>
                        <Button 
                          variant="outline" 
