  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'malayalam': ['Poppins', 'Malayalam Sangam MN', 'Noto Sans Malayalam', 'sans-serif'],
      },
      colors: {
        /* Farm Color System */
        'farm-green': {
        ...
        'harvest-yellow': {
          DEFAULT: 'hsl(var(--harvest-yellow))',
          light: 'hsl(var(--harvest-yellow-light))',
        },
        'orange': {
      ...
      animation: {
        ...
        "fade-slide-up": "fade-slide-up 0.6s cubic-bezier(0.4, 0, 0.2, 1) both",
